...
_fmcomms1_swig.DEFAULT_BUFFER_SIZE_swigconstant(_fmcomms1_swig)
...
class fmcomms1_source(object):
    ...
    def make(uri, frequency, samplerate, bandwidth, device, channels, device_phy, buffer_size=0x8000, decimation=0):
        """
        make(std::string const & uri, unsigned long frequency, unsigned long samplerate, unsigned long bandwidth, std::string const & device, std::vector< std::string,std::allocator< std::string > > const & channels, std::string const & device_phy, unsigned int buffer_size=0x8000, unsigned int decimation=0) -> fmcomms1_source_sptr
        ...
        Args:
            ...
            decimation : 
        """
        return _fmcomms1_swig.fmcomms1_source_make(uri, frequency, samplerate, bandwidth, device, channels, device_phy, buffer_size, decimation)

    make = staticmethod(make)

    def make_from(ctx, frequency, samplerate, bandwidth, device, channels, device_phy, buffer_size=0x8000, decimation=0):
        """make_from(iio_context * ctx, unsigned long frequency, unsigned long samplerate, unsigned long bandwidth, std::string const & device, std::vector< std::string,std::allocator< std::string > > const & channels, std::string const & device_phy, unsigned int buffer_size=0x8000, unsigned int decimation=0) -> fmcomms1_source_sptr"""
        return _fmcomms1_swig.fmcomms1_source_make_from(ctx, frequency, samplerate, bandwidth, device, channels, device_phy, buffer_size, decimation)

    make_from = staticmethod(make_from)

    def set_buffer_size(self, buffer_size):
        """set_buffer_size(fmcomms1_source self, unsigned int buffer_size)"""
        return _fmcomms1_swig.fmcomms1_source_set_buffer_size(self, buffer_size)


    def set_parameters(self, phy, params):
        """set_parameters(fmcomms1_source self, iio_device * phy, std::vector< std::string,std::allocator< std::string > > const & params)"""
        return _fmcomms1_swig.fmcomms1_source_set_parameters(self, phy, params)
...
def fmcomms1_source_make(uri, frequency, samplerate, bandwidth, device, channels, device_phy, buffer_size=0x8000, decimation=0):
    """
...
def fmcomms1_source_make_from(ctx, frequency, samplerate, bandwidth, device, channels, device_phy, buffer_size=0x8000, decimation=0):
    """fmcomms1_source_make_from(iio_context * ctx, unsigned long frequency, unsigned long samplerate, unsigned long bandwidth, std::string const & device, std::vector< std::string,std::allocator< std::string > > const & channels, std::string const & device_phy, unsigned int buffer_size=0x8000, unsigned int decimation=0) -> fmcomms1_source_sptr"""
    return _fmcomms1_swig.fmcomms1_source_make_from(ctx, frequency, samplerate, bandwidth, device, channels, device_phy, buffer_size, decimation)
...
class fmcomms1_source_sptr(object):
    ...
    def make(self, uri, frequency, samplerate, bandwidth, device, channels, device_phy, buffer_size=0x8000, decimation=0):
        """
        make(fmcomms1_source_sptr self, std::string const & uri, unsigned long frequency, unsigned long samplerate, unsigned long bandwidth, std::string const & device, std::vector< std::string,std::allocator< std::string > > const & channels, std::string const & device_phy, unsigned int buffer_size=0x8000, unsigned int decimation=0) -> fmcomms1_source_sptr
        ...
        Args:
            ...
            decimation : 
        """
        return _fmcomms1_swig.fmcomms1_source_sptr_make(self, uri, frequency, samplerate, bandwidth, device, channels, device_phy, buffer_size, decimation)


    def make_from(self, ctx, frequency, samplerate, bandwidth, device, channels, device_phy, buffer_size=0x8000, decimation=0):
        """make_from(fmcomms1_source_sptr self, iio_context * ctx, unsigned long frequency, unsigned long samplerate, unsigned long bandwidth, std::string const & device, std::vector< std::string,std::allocator< std::string > > const & channels, std::string const & device_phy, unsigned int buffer_size=0x8000, unsigned int decimation=0) -> fmcomms1_source_sptr"""
        return _fmcomms1_swig.fmcomms1_source_sptr_make_from(self, ctx, frequency, samplerate, bandwidth, device, channels, device_phy, buffer_size, decimation)


    def set_buffer_size(self, buffer_size):
        """set_buffer_size(fmcomms1_source_sptr self, unsigned int buffer_size)"""
        return _fmcomms1_swig.fmcomms1_source_sptr_set_buffer_size(self, buffer_size)


    def set_parameters(self, phy, params):
        """set_parameters(fmcomms1_source_sptr self, iio_device * phy, std::vector< std::string,std::allocator< std::string > > const & params)"""
        return _fmcomms1_swig.fmcomms1_source_sptr_set_parameters(self, phy, params)
    ...
    def sample_delay(self, which):
        ...
        return _fmcomms1_swig.fmcomms1_source_sptr_sample_delay(self, which)
    ...
    def nitems_read(self, which_input):
        ...
        return _fmcomms1_swig.fmcomms1_source_sptr_nitems_read(self, which_input)


    def nitems_written(self, which_output):
        """nitems_written(fmcomms1_source_sptr self, unsigned int which_output) -> uint64_t"""
        return _fmcomms1_swig.fmcomms1_source_sptr_nitems_written(self, which_output)
    ...
    def set_max_noutput_items(self, m):
        ...
        return _fmcomms1_swig.fmcomms1_source_sptr_set_max_noutput_items(self, m)
    ...
    def set_min_noutput_items(self, m):
        ...
        return _fmcomms1_swig.fmcomms1_source_sptr_set_min_noutput_items(self, m)
    ...
    def max_output_buffer(self, i):
        ...
        return _fmcomms1_swig.fmcomms1_source_sptr_max_output_buffer(self, i)
    ...
    def min_output_buffer(self, i):
        ...
        return _fmcomms1_swig.fmcomms1_source_sptr_min_output_buffer(self, i)
    ...
    def set_processor_affinity(self, mask):
        ...
        return _fmcomms1_swig.fmcomms1_source_sptr_set_processor_affinity(self, mask)
    ...
    def set_thread_priority(self, priority):
        ...
        return _fmcomms1_swig.fmcomms1_source_sptr_set_thread_priority(self, priority)
    ...
    def check_topology(self, ninputs, noutputs):
        ...
        return _fmcomms1_swig.fmcomms1_source_sptr_check_topology(self, ninputs, noutputs)
    ...
    def set_block_alias(self, name):
        ...
        return _fmcomms1_swig.fmcomms1_source_sptr_set_block_alias(self, name)


    def _post(self, which_port, msg):
        """_post(fmcomms1_source_sptr self, swig_int_ptr which_port, swig_int_ptr msg)"""
        return _fmcomms1_swig.fmcomms1_source_sptr__post(self, which_port, msg)
    ...
    def message_subscribers(self, which_port):
        ...
        return _fmcomms1_swig.fmcomms1_source_sptr_message_subscribers(self, which_port)
